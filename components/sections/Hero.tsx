...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-72 h-72 pointer-events-none z-10">
        <svg viewBox="0 0 288 288" className="w-full h-full opacity-90">
          <defs>
            <linearGradient id="petalGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#C41E3A" />
              <stop offset="100%" stopColor="#E24563" />
            </linearGradient>
            <linearGradient id="leafGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#1B4D3E" />
              <stop offset="100%" stopColor="#2D8B68" />
            </linearGradient>
          </defs>
          {/* Leaves */}
          <path
            d="M-20,0 Q60,50 80,150 Q30,100 -10,50 Z"
            fill="url(#leafGrad1)"
          />
          <path
            d="M30,-20 Q100,70 60,180 Q50,90 10,20 Z"
            fill="#236B50"
            opacity="0.8"
          />
          {/* Rose petals */}
      ...
      <div className="absolute top-0 right-0 w-72 h-72 pointer-events-none z-10">
        <svg
          viewBox="0 0 288 288"
          className="w-full h-full opacity-90 transform scale-x-[-1]"
        >
          {/* Leaves */}
          <path
            d="M-20,0 Q60,50 80,150 Q30,100 -10,50 Z"
